    ...
    fun getSampleRecipes(): List<RecipeItem> {
        return listOf(
            RecipeItem(
                ...
                preparation_steps="Place the chicken pieces into a bowl with yogurt, garlic, ginger, lemon juice, coriander, turmeric, cumin, paprika, chilli powder, cinnamon, salt and pepper.\n" +
            ...
            RecipeItem(
                ...
                preparation_steps="Combine ketchup, brown sugar, red wine vinegar, Dijon-style mustard, Worcestershire sauce, and liquid smoke. Stir in salt, pepper, and garlic powder.\n" +
                        "\n" +
                ...
                number_of_people=5,
                imageId = R.drawable.bbq
            ),
            RecipeItem(
                recipe_title = "Spanish Omelette",
                meal_type = "Breakfast",
                difficulty = "Beginner",
                ingredients = "Heat the oil in a nonstick medium-sized (30cm/12-inch) pan. Fry potatoes until crispy, golden and tender. Add the onion and fry until transparent. Drain oil (use a metal colander if you have one), until all of the oil is drained. \n" +
            ...
            RecipeItem(
                ...
                number_of_people=3,
                imageId = R.drawable.curry
            ),
            RecipeItem(
                recipe_title = "Mahamri",
                meal_type = "Breakfast",
                difficulty = "Beginner",
                ingredients = "Plain Flour – all purpose flour, maida, for the dough and extra for dusting.\n" +
                ...
                preparation_steps="PREPARATION OF THE DOUGH:\n" +
